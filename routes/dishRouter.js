...
.post(cors.corsWithOptions, authenticate.verifyUser, (req, res, next) => { // update comments
    Dishes.findById(req.params.dishId)
    .then((dish) => {
        if(dish != null){
...
.delete(cors.corsWithOptions, authenticate.verifyUser,authenticate.verifyAdmin, (req, res, next) => { // Later on, we will learn how to use authentication
    Dishes.findById(req.params.dishId)
